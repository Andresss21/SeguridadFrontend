...
export function storeDoctores(doctor) {
        ...
        axios.post('http://192.168.1.11:8000/api/storeDoctores/', doctor).then((response) => {
...
export function editDoctores(doctor) {
    ...
    axios.put(`http://192.168.1.11:8000/api/editDoctores/${doctor.id}`, doctor).then((response) => {
